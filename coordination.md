...
<button class="people-filter__btn active" data-filter="Core Group">Core Group</button><button class="people-filter__btn" data-filter="WG1">WG1</button><button class="people-filter__btn" data-filter="WG2">WG2</button><button class="people-filter__btn" data-filter="WG3">WG3</button><button class="people-filter__btn" data-filter="MC">MC</button><button class="people-filter__btn" data-filter="all">All</button>
</div>
