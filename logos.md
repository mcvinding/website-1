...
<div class="row g-4 mt-2 mb-5">
  ...
  <div class="col-6 col-md-4 col-lg-3">
    <div class="logo-card">
      <div class="logo-card__preview logo-card__preview--dark">
        <img src="{{ '/assets/images/logo/EEG101_logo_horizontal_transp_noborder.png' | relative_url }}" alt="EEG101 horizontal logo transparent no border">
      </div>
      <div class="logo-card__body">
  ...
  <div class="col-6 col-md-4 col-lg-3">
    <div class="logo-card">
      <div class="logo-card__preview logo-card__preview--dark">
        <img src="{{ '/assets/images/logo/EEG101_logo_squared_transp_noborder.png' | relative_url }}" alt="EEG101 squared logo transparent no border">
      </div>
      <div class="logo-card__body">
  ...
  <div class="col-6 col-md-4 col-lg-3">
    <div class="logo-card">
      <div class="logo-card__preview logo-card__preview--dark">
        <img src="{{ '/assets/images/logo/EEG101_logo_small_transp_noborder.png' | relative_url }}" alt="EEG101 small logo transparent no border">
      </div>
      <div class="logo-card__body">
...
.logo-card__preview--light { background: #f8f9fa; }
.logo-card__preview--dark  { background: #1e2230; }
